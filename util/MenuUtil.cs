...
public class MenuUtil
{
	...
	public static void CarSaleMenu()
	{
        ...
        Console.Write("Seçiminizi edin: ");
			...
			switch (secim)
			{
				case 1: Console.WriteLine("Yeni masin elave etmek");
                    //masin elave etme metodu cagirilir
                    break;
				case 2: Console.WriteLine("Butun masinlar gosterilir");
					// butun masinlar gosterilir
					break;
				case 3: Console.WriteLine("Masin silinir...");
					//masin silme funksiyasi
					break;
				case 4: Console.WriteLine("Masinlari filtrlemek");
                    //filtr funksiyasi
                    break;
				case 5: Console.WriteLine("Cesidleme emeliyyati");
					//sort funksiyasi
					break;
                case 6:
